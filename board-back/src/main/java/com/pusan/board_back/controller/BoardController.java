package com.pusan.board_back.controller;
...
public class BoardController {
    ...
    // boardNumber가 숫자인 경우에만 매핑되도록 정규식 추가
    @GetMapping("/{boardNumber}")
    public ResponseEntity<? super GetBoardResposeDto> getBoard(
        @PathVariable("boardNumber") Integer boardNumber
    ) {
        ResponseEntity<? super GetBoardResposeDto> response = boardService.getBoard(boardNumber);
        return response;
    }
