...
import { PatchBoardReqestDto, PostBoardRequestDto, PostCommentRequestDto } from './request/board';
...
export const patchBoardRequest = async (boardNumber: number | string, requestBody: PatchBoardReqestDto, accessToken: string) => {
